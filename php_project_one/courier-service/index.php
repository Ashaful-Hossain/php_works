...
<?php require('header.php'); ?>
    ...
    <div class="cs_banner_slider_wrapper">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <?php while ($data = $dd->fetch_assoc()) { ?>
                    
                
                <div class="swiper-slide">
                    <div class="cs_header_banner" 
                    style="background-image: url(../uploads/<?php echo $data['photo'] ?>);">
                        <div class="container">
                            <div class="cs_banner_text wow fadeIn slideInLeft" data-wow-duration="0.8s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInLeft;">
                                <h5><?php echo $data['title_1'] ?></h5>
                                <h1><span><?php echo $data['title_2'] ?></span><br><?php echo $data['title_3'] ?></h1>
            ...
            <!-- Add Arrows -->
            <div class="swiper-button-next">Next <img class="next-prev img-fluid" src="assets/images/index/next-arw.png" alt="images"></div>
            <div class="swiper-button-prev"><img src="assets/images/index/prev-arw.png" class="img-fluid" alt="images"> Prev</div>
        </div>
    ...
    <div class="cs_our_services_wrapper">
        <div class="container">
            ...
            <div class="row">
                <?php while($data = $service->fetch_object()){ ?>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box wow zoomIn" data-wow-delay="0.1s">
                        <div class="cs_our_service_icon">
                        <img src="../uploads/<?php echo $data->logo ?>" class="img-fluid" alt="images">
                        </div>
        ...
        <div class="container">
            ...
            <div class="cs_testimonial_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInDown;">
                ...
                <div class="swiper-container">
                        ...
                        <div class="swiper-slide">
                            <div class="cs_testimonial_slides">
                                ...
                                <div class="cs_testimonial_text">
                                    <p><?php echo $data = $tst->comment ?></p>
                                </div>
                                <div class="cs_testimonial_img_name">
                                    <div class="cs_testimonial_img">
                                    <img src="../uploads/<?php echo $data = $tst->photo ?>" class="img-fluid" alt="images">
                                    </div>
                                    <div class="cs_testimonial_name">
                                        <h5><?php echo $data = $tst->name ?></h5>
                                        <p><?php echo $data = $tst->designation ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Add Arrows -->
                    <div class="swiper-button-next"><img src="assets/images/index/next-arw.png" class="img-fluid" alt="images"></div>
                    <div class="swiper-button-prev"><img src="assets/images/index/prev-arw.png" class="img-fluid" alt="images"></div>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from kamleshyadav.com/html/multifarious/html/courier-service/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jan 2024 05:50:59 GMT -->
</html>