...
<body>
    <!-- Preloader Box -->
    <div class="preloader_wrapper preloader_open loaded">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <div class="cs_top_header_info">
                        <div class="cs_top_header_info_call">
                            <p><img src="assets/images/index/call.svg" class="img-fluid" alt="images">Call Us Now - <span>(+91) 1800-214-122</span></p>
                        </div>
                        <div class="cs_top_header_info_mail">
                            <p><img src="assets/images/index/envelope.svg" class="img-fluid" alt="images">Email Us Now - <span>multifarious@example.com</span> </p>
                        </div>
                    </div>
                </div>
    ...
    <!--===Main Header Start===-->
    <div class="cs_header_wrapper fixed_header fixed">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-5">
                    <div class="cs_logo">
                        <a href="index.html"><img src="assets/images/index/logo-Icon.png" alt="logo"></a>
                    </div>
                </div>
    ...
    <div class="cs_banner_slider_wrapper">
        ...
        <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
            <div class="swiper-wrapper" style="transform: translate3d(-6420px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="2" style="width: 1605px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 1605px;">
                    <div class="cs_header_banner">
                        <div class="container">
                ...
                <div class="swiper-slide" data-swiper-slide-index="1" style="width: 1605px;">
                ...
                <div class="swiper-slide swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="2" style="width: 1605px;">
                    <div class="cs_header_banner">
                        <div class="container">
                            <div class="cs_banner_text">
                                <h5>Start shipping with us</h5>
            ...
            <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" data-swiper-slide-index="0" style="width: 1605px;">
                    <div class="cs_header_banner">
                        <div class="container">
                            <div class="cs_banner_text wow fadeIn slideInLeft" data-wow-duration="0.8s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInLeft;">
                                <h5>Start shipping with us</h5>
            ...
            <!-- Add Arrows -->
            <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide">Next <img class="next-prev img-fluid" src="assets/images/index/next-arw.png" alt="images"></div>
            <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide"><img src="assets/images/index/prev-arw.png" class="img-fluid" alt="images"> Prev</div>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                        <div id="header_tab" class="tab_content">
                            ...
                            <div class="cs_tab_form_btn cs_main_btn">
                                <a href="javascript:void(0);">Submit Now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-lg-1 order-md-1 order-sm-2 order-2">
                    <div class="cs_about_img wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                        <img src="assets/images/index/about_img1.png" class="img-fluid" alt="images">
                    </div>
                </div>
                    ...
                    <div class="cs_about_content" data-wow-duration="0.8s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInRight;">
                        ...
                        <ul>
                            <li>
                                <div class="cs_about_icon_box">
                                    <div class="cs_about_icon">
                                        <img src="assets/images/index/about_img2.png" class="img-fluid" alt="images">
                                    </div>
                            ...
                            <li>
                                <div class="cs_about_icon_box">
                                    <div class="cs_about_icon">
                                        <img src="assets/images/index/about_img3.png" class="img-fluid" alt="images">
                                    </div>
                                    <div class="cs_about_icon_text">
                                        <h3>Fast Delivery</h3>
                                        <p>Consectetur adipisicing elit seed desdeo eiusmod</p>
                            ...
                            <li>
                                <div class="cs_about_icon_box">
                                    <div class="cs_about_icon">
                                        <img src="assets/images/index/about_img4.png" class="img-fluid" alt="images">
                                    </div>
                                    <div class="cs_about_icon_text">
                                        <h3>Fast Delivery</h3>
                                        <p>Consectetur adipisicing elit seed desdeo eiusmod</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="cs_people_choose_content wow fadeInLeft" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="cs_people_choose_slider wow fadeInRight" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInRight;">
                        <!-- Swiper -->
                        <div class="swiper-container swiper-container-fade swiper-container-initialized swiper-container-horizontal">
                            <div class="swiper-wrapper" style="transition-duration: 800ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="3" style="width: 588px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/choose_img2.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0" style="width: 588px; opacity: 0; transform: translate3d(-588px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/choose_img2.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide" data-swiper-slide-index="1" style="width: 588px; opacity: 0; transform: translate3d(-1176px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/02.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="2" style="width: 588px; opacity: 0; transform: translate3d(-1764px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/03.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="3" style="width: 588px; opacity: 1; transform: translate3d(-2352px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/choose_img2.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div>
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="0" style="width: 588px; opacity: 0; transform: translate3d(-2940px, 0px, 0px); transition-duration: 800ms;">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="assets/images/index/choose_img2.jpg" class="img-fluid" alt="images">
                                    </div>
                                </div></div>
                            ...
                            <div class="cs_people_choose_slider_arrow">
                                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide"><img src="assets/images/index/next-arw.png" alt="images" class="img-fluid"></div>
                                <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide"><img src="assets/images/index/prev-arw.png" alt="images" class="img-fluid"></div>
                            </div>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                    </div>
                </div>
    ...
    <div class="cs_our_services_wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon1.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                            ...
                            <a href="javascript:void(0);">Read More <img src="assets/images/index/read_btn.png" alt="images" class="img-fluid"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon2.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon3.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                            <h1>Ground Freight</h1>
                            <p>Sorem ipsum dolor sit amet consectetur adipisicing elitsed do eiusmod tempor incididunt ut laboredolore.</p>
                            <a href="javascript:void(0);">Read More <img src="assets/images/index/read_btn.png" class="img-fluid" alt="images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box cs_our_service_box2 wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon4.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                            <h1>Home Delivery</h1>
                            <p>Sorem ipsum dolor sit amet consectetur adipisicing elitsed do eiusmod tempor incididunt ut laboredolore.</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box cs_our_service_box2 wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon5.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                            <h1>Air Freight</h1>
                            <p>Sorem ipsum dolor sit amet consectetur adipisicing elitsed do eiusmod tempor incididunt ut laboredolore.</p>
                            <a href="javascript:void(0);">Read More <img src="assets/images/index/read_btn.png" alt="images"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box cs_our_service_box2 wow zoomIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: zoomIn;">
                        <div class="cs_our_service_icon">
                            <img src="assets/images/index/services_icon6.png" class="img-fluid" alt="images">
                        </div>
                        <div class="cs_our_service_content">
                            <h1>Warehousing</h1>
                            <p>Sorem ipsum dolor sit amet consectetur adipisicing elitsed do eiusmod tempor incididunt ut laboredolore.</p>
    ...
    <div class="cs_testimonial_wrapper">
        <div class="container">
            ...
            <div class="cs_testimonial_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInDown;">
                <!-- Swiper -->
                <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper" style="transform: translate3d(-4104px, 0px, 0px); transition-duration: 800ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="3" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" alt="images" class="img-fluid">
                                </div>
                                ...
                                <div class="cs_testimonial_img_name">
                                    <div class="cs_testimonial_img">
                                        <img src="assets/images/index/circle_img.png" class="img-fluid" alt="images">
                                    </div>
                        ...
                        <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" class="img-fluid" alt="images">
                                </div>
                                <div class="cs_testimonial_text">
                                    <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida sus commodo viversdera maecenas accumsan lacus vel adn the part of multifarious
                                        and the naame facilisis. </p>
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="1" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" class="img-fluid" alt="images">
                                </div>
                        ...
                        <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="2" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" class="img-fluid" alt="images">
                                </div>
                        ...
                        <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="3" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" alt="images" class="img-fluid">
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="0" style="width: 996px; margin-right: 30px;">
                            <div class="cs_testimonial_slides">
                                <div class="cs_testimonial_quote">
                                    <img src="assets/images/index/quote.png" class="img-fluid" alt="images">
                                </div>
                    ...
                    <!-- Add Arrows -->
                    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide"><img src="assets/images/index/next-arw.png" class="img-fluid" alt="images"></div>
                    <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide"><img src="assets/images/index/prev-arw.png" class="img-fluid" alt="images"></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-12 col-12">
                    <div class="cs_pricing_calculate_table wow fadeInLeft" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft;">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 col-12">
                    <div class="cs_pricing_charge_table wow fadeInRight" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInRight;">
    ...
    <div class="cs_blog_wrapper">
            ...
            <div class="row">
                    ...
                    <div class="cs_blog_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInLeft;">
                        <div class="cs_blog_img_box">
                            <div class="cs_blog_img">
                                <img src="assets/images/index/blog_img1.jpg" class="img-fluid" alt="images">
                        ...
                        <div class="cs_blog_user_comment">
                            <div class="cs_blog_user">
                                <a href="javascript:void(0);"><img src="assets/images/index/user.png" class="img-fluid" alt="images"> By - Admin</a>
                            </div>
                            <div class="cs_blog_comment">
                                <a href="javascript:void(0);"><img src="assets/images/index/comment.png" class="img-fluid" alt="images"> 04 Comments</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_blog_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInDown;">
                        <div class="cs_blog_img_box">
                            <div class="cs_blog_img">
                                <img src="assets/images/index/blog_img2.jpg" class="img-fluid" alt="images">
                                <div class="cs_blog_date">
                                    <h1>29</h1>
                                    <p>Oct 2020</p>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_blog_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInRight;">
                        <div class="cs_blog_img_box">
                            <div class="cs_blog_img">
                                <img src="assets/images/index/blog_img3.jpg" class="img-fluid" alt="images">
                                <div class="cs_blog_date">
                                    <h1>29</h1>
                                    <p>Oct 2020</p>
                                </div>
     ...
     <!--===================Contact Section==================-->
     <div class="cs_contact_wrapper wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_contact_box" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInLeft;">
                        <img src="assets/images/index/time.svg" class="img-fluid" alt="images">
                        <h1>Opening Hours</h1>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_contact_box" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInDown;">
                        <img src="assets/images/index/SVG/Footer/phone.svg" class="img-fluid" alt="images">
                        <h1>Call Us Anytime</h1>
                        <p>(+91) 1800-214-122<br> (+91) 1800-214-123
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_contact_box" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInRight;">
                        <img src="assets/images/index/email.svg" class="img-fluid" alt="images">
                        <h1>Mail Us</h1>
                        <p>support@multifarious.com<br> support@courier.com
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="cs_footer_wrapper">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="cs_footer_section1">
                        <div class="cs_footer_logo">
                            <a href="index.html"><img src="assets/images/index/logo.png" class="img-fluid" alt="images"> Multifarious</a>
                        </div>
        ...
        <div class="cs_copyright">
            <p>Copyright © 2021 <a href="javascript:void(0);">Multifarious</a>. All Right Reserved.</p>
        </div>
    </div>
    <!-- GO To Top -->
    <a href="javascript:void(0);" id="scroll" class="active"><span class="fa fa-angle-double-up"></span></a>
    <!-- Script Start -->
